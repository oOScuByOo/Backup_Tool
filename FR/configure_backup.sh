...
echo "-                                              -";
echo "-              Crée pour Intersect             -";
echo "-                                              -";
echo "-  vous pouvez modifier / editer / supprimer   -";
echo "-   faire ce que vous voulez avec ce script    -";
echo "-                                              -";
echo "- /!\ ATTENTION : EDITEZ A VOS PROPRES RISQUES -";
echo "-  Vous seul etes responsable en cas d'erreur  -";
echo "-    MOI MEME ou la DEV TEAM d'Intersect ne    -";
echo "-          peut etre RESPONSABLE   /!\         -";
echo "-                                              -";
echo "-                Fait pour vous par oOScuByOo  -";
echo "------------------------------------------------";
echo "";
  ...
  if [ "$Intervalle" = "j" ]
    ...
    then
      ...
      then
        ...
        cd;
        echo "backup.sh est maintenant éxecutable."
        echo "";
      else
